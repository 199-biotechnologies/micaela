  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-20">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
              <div className="text-center">
                <h3 className="text-xl font-light tracking-tight mb-4">Concierge</h3>
              ...
              <div className="text-center">
                <h3 className="text-xl font-light tracking-tight mb-4">Spa & Fitness</h3>
                <p className="text-gray-600 text-sm font-light">
              ...
              <div className="text-center">
                <h3 className="text-xl font-light tracking-tight mb-4">Indoor Heated Pool</h3>
                <p className="text-gray-600 text-sm font-light">
              ...
              <div className="text-center">
                <h3 className="text-xl font-light tracking-tight mb-4">Outdoor Pool</h3>
                <p className="text-gray-600 text-sm font-light">
              ...
              <div className="text-center">
                <h3 className="text-xl font-light tracking-tight mb-4">Security</h3>
                <p className="text-gray-600 text-sm font-light">
            ...
            <p className="text-center text-gray-700 mt-16 max-w-4xl mx-auto leading-relaxed font-light">
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-4xl font-light tracking-tight mb-6">TAILORED EXPERIENCE</h2>
              </div>
        ...
        <section className="py-20 px-4 bg-gray-50">
          <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-4xl font-light tracking-tight mb-6">PRIME LOCATION</h2>
            <p className="text-gray-700 text-lg max-w-3xl mx-auto leading-relaxed font-light">
